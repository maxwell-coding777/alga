...
#ifdef testing
	twoDiffAIbutton = new button(pos, "Start 2P Diff AI");
	twoDiffAIbutton->setcallback(11);
#endif
#ifdef fourplayers
...
#define NO_ARG 5
        ...
        case 9:
			...
			return;
       	case 10:
       		// start 4P IA game (local)
			gametype = GAME4PMATCH;
			board_selection();
			return;
		case 11:
			// start 2P IA game with different IA (local)
			gametype = GAME2PDMATCH;
			twoDiffIA = true;
			board_selection();
			return;
        case 8:
